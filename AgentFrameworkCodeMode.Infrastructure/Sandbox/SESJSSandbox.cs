...
{
    public class SESJSSandbox : ISandbox
    {
        ...
        public async Task<SandboxOutput> ExecuteCodeAsync(string agentId, string code, CancellationToken cancellationToken = default)
        {
            try
            {
                var result = await RunCode(agentId, code);
        ...
        private async Task<string> RunCode(string agentId, string code)
        {
